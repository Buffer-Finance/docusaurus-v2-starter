...
Currently 4 different types of tournaments can be hosted, each with a varying parameters around buy-ins, price pool, and tournament rewards:

### Type 1:

![Type 1 Image](/img/general/type1.png)
...
![Type 2 Image](/img/general/type2.png)
...
![Type 3 Image](/img/general/type3.png)

- **Prize Pool:** Not guaranteed; entirely built from the buy-in tokens. 
- **Reward Token:** Same as the buy-in token. 
- **Participant Requirement:** Defined by the admin/host. Tournament does not start unless the minimum participant criteria are met. 

### Type 4:
- **Prize Pool**: combination of guranteed rewards provided by the admin and a percentage built from buy-in tokens.
- **Participant Requirement:** Defined by the admin/host. Tournament does not start unless the minimum participant criteria are met. 
